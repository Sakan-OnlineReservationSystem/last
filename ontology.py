#all_domains = ['restaurant', 'hotel', 'attraction', 'train', 'taxi', 'police', 'hospital','apartment']
all_domains = ['hotel']
#db_domains = ['restaurant', 'hotel', 'attraction', 'train','apartment']
...
requestable_slots = {
    ...
    "police": ["postcode", "address", "phone"],
    "hospital": ["address", "phone", "postcode"],
    "hotel": ["address", "postcode", "internet", "phone", "parking", "type", "pricerange", "stars", "area", "reference","view"],
    "attraction": ["price", "type", "address", "postcode", "phone", "area", "reference"],
    "train": ["time", "leave", "price", "arrive", "id", "reference"],
    "restaurant": ["phone", "postcode", "address", "pricerange", "food", "area", "reference"],
    "apartment" : ["address", "postcode", "internet", "phone", "parking", "type", "pricerange", "stars", "area", "reference","view", "rooms"]
}
